...
public class Model {
    ...
    public final void setHeight(int feet, int inches)  {
        int heightInInces = feet * INCHES_PER_FOOT + inches;
        if (heightInInces >= 24 && heightInInces <= 84) {
            this.height = heightInInces;
        }
    }
    ...
    public final void setWeight(long kilograms) {
        double weightInLbs = kilograms * POUNDS_PER_KG;
        if (weightInLbs >= 80 && weightInLbs <= 280) {
    ...
    public void printDetails() {
        ...
        String smokesMessage = smokes ? "Does smoke" : "Does not smoke";
        System.out.println(smokesMessage);
    }
    ...
    public void displayModelDetails() {
        ...
        String smokesMessage = smokes ? "yep" : "nope";
        System.out.println("Smokes: " + smokesMessage);
